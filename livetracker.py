...
#############################################################################
mapbox_access_token = 'sk.eyJ1IjoiY2hhcml0YWNoYWxsYSIsImEiOiJja2FheHc3MHcxMTg3MnRta3AxZTJ1ZGZwIn0.HgcHyoFJGcTNJ967MXJ8WQ'
...
#Map, Table
 ...
 html.Div(
                    [
                        html.Hr(),
                        html.P('Open Source Code by Unicorndy. License  ',
                               style={'display': 'inline'}),
                        html.A('Github',
                               href='https://github.com/Unicorndy/covid19_dashboard/blob/master/LICENSE'),
                        html.P(' 2020.',
                            style={'display': 'inline'}),
                        html.Hr(),
                    ], className="twelve columns",
